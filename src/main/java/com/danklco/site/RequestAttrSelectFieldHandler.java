...
public class RequestAttrSelectFieldHandler implements FieldHandler {

	private static final Logger log = LoggerFactory.getLogger(RequestAttrSelectFieldHandler.class);

	@Override
	public boolean handles(Resource fieldResource) {
		return "danklco-com/components/form/requestattrselect".equals(fieldResource.getResourceType());
	}
