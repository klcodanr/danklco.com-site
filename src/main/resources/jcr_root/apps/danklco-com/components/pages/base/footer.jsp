...
<footer class="transparent-block-inverse row">
	...
	<div class="float-right" itemscope itemtype="http://schema.org/Person">
		...
		<ul class="nav">
			...
			<li class="nav-item">
				<span class="nav-link p-1">
					<a itemprop="sameAs" href="https://twitter.com/KlcoDanR" title="Find me on Twitter!" target="_blank" rel="noopener" class="btn btn-default">
			...
			<li class="nav-item">
				<span class="nav-link p-1">
					<a itemprop="sameAs" href="https://plus.google.com/109214091683324297793?rel=author" target="_blank" rel="noopener" title="Find me on Google Plus!" class="btn btn-default">
			...
			<li class="nav-item">
				<span class="nav-link p-1">
					<a itemprop="sameAs" href="https://github.com/klcodanr" title="Find me on GitHub!" target="_blank" rel="noopener" class="btn btn-default">
			...
			<li class="nav-item">
				<span class="nav-link p-1">
					<a itemprop="sameAs" href="/feed.xml" title="Follow my RSS Feed" target="_blank" rel="noopener" class="btn btn-default">
