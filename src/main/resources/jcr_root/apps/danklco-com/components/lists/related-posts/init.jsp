...
<c:set var="query" value="SELECT * FROM [sling:Page] WHERE ISDESCENDANTNODE([/content/danklco-com/posts]) AND [jcr:content/publishDate] IS NOT NULL AND NOT [jcr:path] = '${page.path}' AND ([jcr:content/sling:taxonomy]='${params}')" scope="request" />
