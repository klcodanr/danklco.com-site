...
function img() {
  return src('./src/main/frontend/img/*.*')
    .pipe(dest('./target/dist/jcr_root/static/clientlibs/danklco-com/img'));
}
...
function fonts() {
  return src([
    ...
    .pipe(dest('./target/dist/jcr_root/static/clientlibs/danklco-com/fonts'));
}
